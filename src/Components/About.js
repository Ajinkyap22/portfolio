...
function About() {
  return (
    ...
    >
      ...
      <p className="my-4 text-sm 2xl:text-lg 3xl:text-xl px-2 lg:my-6 font-[500] dark:font-[400] md:w-1/2 xl:w-1/3 mx-auto leading-6">
      ...
      <p className="my-4 text-sm 2xl:text-base 3xl:text-lg lg:my-6 font-[500] dark:font-[400] md:w-1/2 xl:w-1/3 mx-auto leading-6">
      ...
      <a
        href="#techstack"
        className="p-3 px-4 lg:px-6 text-sm md:text-base 2xl:text-base 3xl:text-lg my-5 inline-block bg-button text-white rounded-lg font-bold tracking-wide hover:scale-105 transition-all"
      >
        My Tech Stack{" "}
        <svg
