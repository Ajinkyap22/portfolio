  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-3 px-4 lg:px-6 text-sm md:text-base 2xl:text-xl 3xl:text-2xl mt-16 2xl:mt-24 bg-button text-white rounded-lg font-bold tracking-wide hover:scale-105 transition-all"
      >
